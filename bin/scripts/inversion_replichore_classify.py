...
parser.add_argument('--ancestor', help='name of ancestor clone')
...
def classify_inversion(file,df_oridif,ancestor):
...
def generate_inversion_table(df,clone): # a summary table of all inversions, their type, length across a given clone
    ...
    df_temp = pd.DataFrame(columns=['clone','classification','length','mechanism','symmetry_stat_log','symmetry_ratio','symmetry_ratio_length'])
...
def main(folder,output,oridif,ancestor):
    ...
    for file in csv_names:
        print (file)
        summary_dict, df =classify_inversion(file, df_oridif,ancestor)
        clone=file.replace('_inversion.csv','') # get the name of the clone 
...
if __name__ == '__main__':
    ...
    main(args.folder,args.output,args.oridif, args.ancestor)
